...
It is always a good idea to keep some information private. 
[DroidFS](https://f-droid.org/packages/sushi.hardcore.droidfs) can be used on Android. The volumes created by it are compatible with [Gocryptfs](https://github.com/rfjakob/gocryptfs).
